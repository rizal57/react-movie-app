import { IconBrandGithub, IconHome, IconPlayerPlay, IconSearch } from '@tabler/icons';
    ...
    return (
        <div className="bg-slate-900 md:bg-transparent transition ease-in duration-300 md:h-screen h-16 flex md:flex-col justify-between items-center md:px-1 px-4 fixed left-0 md:top-0 bottom-0 md:w-[70px] w-full md:z-[inherit] z-50 shadow-md">
            ...
            <div className="md:pb-8 flex-shrink-0">
                <a
                    className={'block p-2 rounded-full bg-slate-100 hover:bg-black duration-300 group'}
                    target="_blank"
                    href="https://github.com/rizal57/react-movie-app">
                    <IconBrandGithub className="stroke-black group-hover:stroke-slate-100" />
                </a>
